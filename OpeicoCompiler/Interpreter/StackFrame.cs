...
namespace OpeicoCompiler.Interpreter
{
    internal class StackFrame
    {
        ...
        internal void AddVariables(Dictionary<string, object?> variables, OpeicoInterpreter interpreter)
        {
        ...
        internal object? AddVariable(Stmt.Var variable, OpeicoInterpreter interpreter)
        {
